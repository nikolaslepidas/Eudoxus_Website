...
CREATE TABLE `course_has_book` (
  ...
  PRIMARY KEY (`course_idcourse`,`book_isbn`),
  KEY `fk_course_has_book_book1_idx` (`book_isbn`),
  KEY `fk_course_has_book_course_idx` (`course_idcourse`),
  CONSTRAINT `fk_course_has_book_book1` FOREIGN KEY (`book_isbn`) REFERENCES `book` (`isbn`),
  CONSTRAINT `fk_course_has_book_course` FOREIGN KEY (`course_idcourse`) REFERENCES `course` (`idcourse`)
...
INSERT INTO `course_has_book` VALUES (1,156575),(1,167636),(1,178345);
...
-- Dump completed on 2019-01-14 12:57:00
